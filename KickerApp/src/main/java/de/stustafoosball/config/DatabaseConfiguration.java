package de.stustafoosball.config;

import de.stustafoosball.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("de.stustafoosball.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("de.stustafoosball.repository.search")
